...
# Game Title
pygame.display.set_caption("SnakeGameBySiddharth")
...
def welcome():
    ...
    while not exit_game:
        ...
        text_screen("~ by SIDDHARTH", red, 550, 500)
...
def gameloop():
    ...
    while not exit_game:
        if game_over:
            ...
            text_screen("~ game by SIDDHARTH", red, 450, 500)
